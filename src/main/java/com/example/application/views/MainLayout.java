 ...
 */
@PWA(name = "Personal Expenses App", shortName = "Personal Expenses App", enableInstallPrompt = false)
@Theme(themeFolder = "personalexpensesapp")
@PageTitle("Main")
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent() {
        H2 appName = new H2("Personal Expenses App");
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                new MenuItemInfo("Income", "la la-credit-card", IncomeView.class), //
